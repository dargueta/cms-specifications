...
BEQ4RX_RENDERED_YAML_TARGETS=$(addprefix file_formats/beq4rx,$(GENERIC_HEADER_DETAIL_TRAILER_TARGETS))
BQN4_RENDERED_YAML_TARGETS=$(addprefix file_formats/bqn4,$(GENERIC_HEADER_DETAIL_TRAILER_TARGETS))
ALL_RENDERED_YAML_TARGETS=$(BEQ4RX_RENDERED_YAML_TARGETS) $(BQN4_RENDERED_YAML_TARGETS)

.DELETE_ON_FAILURE:

# BEQ4RX -----------------------------------------------------------------------
build/beq4rx/18.6/%: file_formats/beq4rx/18.7/%
build/beq4rx/18.8/%: file_formats/beq4rx/18.7/%

# BQN4 -------------------------------------------------------------------------
build/bqn4/18.6/%: file_formats/bqn4/18.7/%
build/bqn4/18.8/%: file_formats/bqn4/18.7/%
